...
SPDK_KERNEL_CONFIG_DIR = '/sys/kernel/config/nvmet'
SPDK_NODE_A_ANA_GRPID = 2
SPDK_NODE_B_ANA_GRPID = 3
SPDK_NQN_UUID = 'nqn.2011-06.com.truenas:uuid'
SPDK_SERVICE_NAME = 'spdk'
SPDK_MAX_NSID = 0xFFFFFFFE
